...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference("Produto.count") do
      post produtos_url, params: { produto: { descricao: @produto.descricao, nome: @produto.nome, prazo: @produto.prazo, preco: @produto.preco, tamanho: @produto.tamanho } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { descricao: @produto.descricao, nome: @produto.nome, prazo: @produto.prazo, preco: @produto.preco, tamanho: @produto.tamanho } }
